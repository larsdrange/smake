  ...
  return (
    <>
      <TopBar
        ...
        rightElement={
          isOwn ? (
            <Link href="/settings" className="p-2 text-gray-500">
              <Settings size={20} />
            </Link>
          ) : null
        }
      ...
      <div className="px-4 pt-4 space-y-5 pb-4">
              ...
              {favorites.map((fav) => {
                ...
                return r ? (
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-400 ml-auto">{r.address}</span>
                  </Link>
                ) : null;
              })}
            </div>
        ...
        {checkIns?.length === 0 && (
          <div className="text-center py-12 text-gray-400">
            ...
            {isOwn && (
              <Link href="/checkin" className="mt-3 inline-block text-sm text-brand-600 font-medium">
